...
use mm\utils\{GameChooser, IronSwordEntity, DiamondSwordEntity, WoodSwordEntity, StoneSwordEntity, GoldSwordEntity, Vector, DeadPlayerEntity};
...
class MurderMystery extends PluginBase implements Listener{
    ...
    public function onEnable(){
        ...
        Entity::registerEntity(IronSwordEntity::class, true);
        Entity::registerEntity(DiamondSwordEntity::class, true);
        Entity::registerEntity(GoldSwordEntity::class, true);
        Entity::registerEntity(StoneSwordEntity::class, true);
        Entity::registerEntity(WoodSwordEntity::class, true);
